alert('Попереджаю!Цей сайт використовує файли `cookies`,та я гарантую що дані про тебе - не будуть надіслані третім обличчям.Також,сайт оптимізований для комп'ютерів тож - вибач за не гарний інтерфейс')
